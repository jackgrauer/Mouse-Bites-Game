/// @function	sys_layer_draw_option_legacy();
...
function sys_layer_draw_option_legacy() {
	...
	Draws options with reduced rendering features for performance and compatibility 
	...
	*/
	...
	for (ds_yindex = 0; ds_yindex < ds_grid_height(ds_option); ds_yindex += 1) {
	   ...
	   if (ds_option[# prop._id, ds_yindex] != -1) {
		  ...
		  //Get sprite index
		  var action_index = ds_option[# prop._img_index, ds_yindex];
	      ...
	      draw_text_transformed_color(action_x + point_rot_x((action_text_x*action_xscale), (action_text_y*action_yscale)), action_y + point_rot_y((action_text_x*action_xscale), (action_text_y*action_yscale)), action_string, action_xscale, action_yscale, action_rot, action_col, action_col, action_col, action_col, action_alpha*global.vg_ui_alpha);
