...
function anim_siren() {
	...
	*/
	...
	if (keyframe()) {
	   anim_col1 = c_white;
	   anim_col2 = merge_color(c_red, c_white, 0.5);
	   anim_col3 = anim_col2;
	   anim_col4 = c_white;
	}

	if (keyframe()) {
	   anim_col1 = merge_color(c_red, c_white, 0.5);
	   anim_col2 = c_white;
	   anim_col3 = c_white;
	   anim_col4 = anim_col1;   
	}
	...
	if (keyframe()) {
	   anim_col1 = c_white;
	   anim_col2 = merge_color(c_blue, c_white, 0.5);
	   anim_col3 = anim_col2;
	   anim_col4 = c_white;
	}

	if (keyframe()) {
	   anim_col1 = merge_color(c_blue, c_white, 0.5);
	   anim_col2 = c_white;
	   anim_col3 = c_white;
	   anim_col4 = anim_col1;   
	}
