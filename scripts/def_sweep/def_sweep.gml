...
function def_sweep() {
	...
	*/
	...
	if (keyframe()) {
	   ...
	   def_xpoint[0, 2] = input_width*0.02;   def_xpoint[1, 2] = input_width*-0.02;
	   def_ypoint[0, 2] = 0;                  def_ypoint[1, 2] = input_height*0.01;
   
	   //Col 0 | Row 3                        Col 1 | Row 3
	   def_xpoint[0, 3] = input_width*0.05;   def_xpoint[1, 3] = input_width*0.03; 
	   def_ypoint[0, 3] = input_height*0.02;  def_ypoint[1, 3] = input_height*0.02;
