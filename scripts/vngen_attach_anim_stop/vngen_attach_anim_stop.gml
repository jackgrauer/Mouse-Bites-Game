/// @function	vngen_attach_anim_stop(name, id);
/// @param		{string|macro}	name
/// @param		{real|string}	id
/// @author		Lucas Chasteen <lucas.chasteen@xgasoft.com>
/// @copyright	XGASOFT 2020, All Rights Reserved
function vngen_attach_anim_stop(argument0, argument1) {

	/*
	Stops a scripted animation playing on the specified attachment, if any. All values modified 
	...
	argument1 = identifier of the attachment on which to stop animation (real or string) (or keyword 'all' for all)
	      ...
	      if (!is_undefined(ds_char_target)) {  
	         ...
	         if (!is_undefined(ds_attach_target)) {
	            while (ds_attach_target >= ds_xindex) {  
	               ...
	               sys_anim_term(ds_attach, ds_attach_target);
