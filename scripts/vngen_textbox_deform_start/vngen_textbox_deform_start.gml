/// @function	vngen_textbox_deform_start(id, def, duration, loop, reverse, [ease]);
...
function vngen_textbox_deform_start() {

	/*
	Applies a scripted deformation to the specified textbox. Deformation scripts are written 
	...
	argument0 = identifier of the textbox on which to perform deformation (real or string) (or keyword 'all' for all)
	...
	Example usage:
	   vngen_event() {
	      vngen_textbox_deform_start("textbox", def_wave, 3, true, false);
	   }
	*/
	   ...
	   case true: {
	      ...
	      if (!is_undefined(ds_target)) {    
	         ...
	         while (ds_target >= ds_yindex) {            
	            ...
	            sys_deform_init(ds_textbox, ds_target, argument[1], argument[2], argument[3], argument[4], action_ease);
