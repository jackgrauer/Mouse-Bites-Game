/// @function	vngen_label_deform_start(id, def, duration, loop, reverse, [ease]);
...
function vngen_label_deform_start() {

	/*
	Applies a scripted deformation to the specified label. Deformation scripts are written 
	...
	argument0 = identifier of the label on which to perform deformation (real or string) (or keyword 'all' for all)
	...
	Example usage:
	   vngen_event() {
	      vngen_label_deform_start("label", def_wave, 3, true, false);
	   }
	*/
	   ...
	   case true: {
	      ...
	      if (!is_undefined(ds_target)) { 
	         ...
	         while (ds_target >= ds_yindex) {           
	            ...
	            sys_deform_init(ds_label, ds_target, argument[1], argument[2], argument[3], argument[4], action_ease);
