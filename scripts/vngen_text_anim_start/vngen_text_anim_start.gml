/// @function	vngen_text_anim_start(id, anim, duration, loop, reverse, [ease]);
...
function vngen_text_anim_start() {

	/*
	Applies a scripted animation to the specified text. Animation scripts are written 
	...
	argument0 = identifier of the text on which to perform animation (real or string) (or keyword 'all' for all)
	...
	Example usage:
	   vngen_event() {
	      vngen_text_anim_start("text", anim_wiggle, 0.5, true, false);
	   }
	*/
	   ...
	   case true: {
	      ...
	      if (!is_undefined(ds_target)) {    
	         ...
	         while (ds_target >= ds_yindex) { 
	            ...
	            sys_anim_init(ds_text, ds_target, argument[1], argument[2], argument[3], argument[4], action_ease);
