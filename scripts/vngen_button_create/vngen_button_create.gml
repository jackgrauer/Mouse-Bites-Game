/// @function	vngen_button_create(id, text, sprite, spr_hover, spr_select, x, y, z, font, color, transition, duration, [ease]);
...
function vngen_button_create() {

	/*
	Creates a new button which will be displayed until vngen_button_destroy is run.
	Buttons can be used to execute arbitrary code in response to mouse or touch input
	with vngen_get_button. Other input devices can activate buttons directly with 
	...
	Example usage:
	   vngen_event() {
	      vngen_button_create("btn", "Click me!", spr_btn, spr_btn_hover, spr_btn_select, 256, 512, 0, fnt_Arial, c_white, trans_fade, 3);
	   }
	*/
	...
	*/
	...
	switch (sys_action_init()) {
	   ...
	   case true: {
	      ...
	      ds_button[# prop._anim_tmp_col1, ds_target] = argument[9]; //Hover text color
	      ds_button[# prop._anim_tmp_x, ds_target] = argument[5];    //Hover X
	      ds_button[# prop._anim_tmp_y, ds_target] = argument[6];    //Hover Y
	      ...
	      ds_button[# prop._anim_col1, ds_target] = argument[9];     //Select text color
	      ds_button[# prop._anim_x, ds_target] = argument[5];        //Select X
	      ds_button[# prop._anim_y, ds_target] = argument[6];        //Select Y
	      ...
	      sys_trans_init(ds_button, ds_target, argument[10], argument[11], false);
