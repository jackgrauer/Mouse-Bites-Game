/// @function	cmd_vngen_set_lang(lang, [type]);
/// @param		{real|string}	lang
/// @param		{integer|macro}	[type]
/// @author		Lucas Chasteen <lucas.chasteen@xgasoft.com>
/// @copyright	XGASOFT 2020, All Rights Reserved
function cmd_vngen_set_lang() {
	...
	*/
	...
	if (argument_count > 1) {
	   if (string_letters(argument[1]) == "") {
	      //Numeric type
	      type = real(argument[1]);
	   } else {
	      //Macro type
	      switch (argument[1]) {
	   ...
	   //Otherwise set language for all types
	   vngen_set_lang(lang);
	}

	//Return result dialog
	return "Language flag successfully set";
